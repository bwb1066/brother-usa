...
const siteKey = 'brother';
let brandName = 'Brother';
let contactUrl = 'https://www.brother-usa.com/contact-us';
...
function buildModal(initialQuery) {
  ...
  disclaimer.innerHTML = 'AI responses may be inaccurate. <a href="https://www.brother-usa.com/terms-of-use" target="_blank" rel="noopener">Terms of Use</a>.';
